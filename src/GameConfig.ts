...
import MainSceneUI from "./script/MainSceneUI"
import GameStart from "./script/GameStart"
import ButtonScale from "./script/ButtonScale"
...
export default class GameConfig{
    ...
    static init(){
        ...
        reg("script/MainSceneUI.ts",MainSceneUI);
        reg("script/GameStart.ts",GameStart);
        reg("script/ButtonScale.ts",ButtonScale);
